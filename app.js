...
var $author$project$PhotoGroove$photoArray = function (model) {
	return $elm$core$Array$fromList(model.photos);
};
var $author$project$PhotoGroove$getPhoto = F2(
	function (index, model) {
		return A2(
			$elm$core$Array$get,
			index,
			$author$project$PhotoGroove$photoArray(model));
	});
...
var $author$project$PhotoGroove$randomPhotoPicker = function (model) {
	return A2(
		$elm$random$Random$int,
		0,
		$elm$core$Array$length(
			$author$project$PhotoGroove$photoArray(model)) - 1);
};
			...
			case 'ClickedSurpriseMe':
				return _Utils_Tuple2(
					...
					A2(
						...
						$author$project$PhotoGroove$randomPhotoPicker(model)));
			default:
				var index = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							selectedPhoto: A2($author$project$PhotoGroove$getPhoto, index, model)
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
